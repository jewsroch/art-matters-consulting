            ...
            if($lcptu && $lcptu->have_posts()) {
                ...
                while($lcptu->have_posts()) {
                    ...
                    <li class="post-<?php echo $id; ?> <?php echo ($count%2)?'odd':'even'; ?>">
                        ...
                        <?php echo '<a href="'.get_permalink($id).'" class="tm_lcptu_post_title_link">'.get_the_title($id).'</a>'; ?>
                        <?php
